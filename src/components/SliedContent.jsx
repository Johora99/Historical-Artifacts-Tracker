  ...
  return (
         <div>
          <div className="text-center">
            ...
            <button className="text-white border-[3px] border-TealBlueGreen bg-TealBlueGreen py-3 px-10 text-xl font-semibold bg-opacity-[0.5] hover:bg-opacity-[1]">Learn More</button>
          </div>
         </div>
  )
}
