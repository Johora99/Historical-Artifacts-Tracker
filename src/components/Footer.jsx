	...
	<div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
		...
		<div className="grid justify-center pt-6 lg:justify-between text-TealBlueGreen">
			...
			<div data-aos="zoom-in" className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
				...
				<a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 bg-white rounded-full hover:bg-TealBlueGreen hover:text-white transition-all duration-300">
				...
				<a rel="noopener noreferrer" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full bg-white hover:bg-TealBlueGreen hover:text-white transition-all duration-300">
